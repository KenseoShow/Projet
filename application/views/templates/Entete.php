...
<a href="<?php echo site_url('visiteur/seDeconnecter') ?>">Se déconnecter</a>&nbsp;&nbsp;
      ...
      <?php endif; ?>
              ...
              <a href="<?php echo site_url('Administrateur/SupprimerUnProduit')?>">Supprimer Un Produit</a>&nbsp;&nbsp;
              <a href="<?php echo site_url('Administrateur/ModificationUnProduit')?>">Modifier Un Produit</a>&nbsp;&nbsp;
              <a href="<?php echo site_url('Visiteur/ModificationUnCompte')?>">Modifier Compte</a>&nbsp;&nbsp;
              <?php endif; ?>
<?php else : ?>
