...
$this->load->view('templates/PiedDePage');
   ...
   'cNomFichierImage' => $this->input->post('txtNomFichierImage')
    ...
    {
      $config["base_url"] = site_url('administrateur/supprimerUnArticle');
      $DonneesInjectees['TitreDeLaPage'] = 'Supprimer Un Article';
      $this->load->view('templates/Entete');
      $this->load->view('administrateur/supprimerUnArticle', $DonneesInjectees);
      $this->load->view('templates/PiedDePage');
    }
}
